...
class Admin_products extends REST_Controller {
    public function __construct() {
        parent::__construct();
        $this->load->database();
        $this->table= 'products';
        $this->model_name='admin_products_model';   
    ...
    */		
	...
	function get_product_metrics($id){
		$metrics = $this->db->get_where('product_metrics', array('productId'=>$id))->result_array();
		return $metrics;
	}
