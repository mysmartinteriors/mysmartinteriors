...
class User extends CI_Model{    
    ...
    static function get_deliveryId()
    {
		$ci =& get_instance();
        return $ci->session->userdata('gt_dId');
    }

	static function get_deliveryName()
    {
		$ci =& get_instance();
        return $ci->session->userdata('gt_dUname');
    }
    ...
    static function is_active()
    {
        // $userdata=array(
        //     'gt_aId'=>$row_data['id'],
        //     'gt_aUname'=>$row_data['first_name'].' '.$row_data['last_name'],
