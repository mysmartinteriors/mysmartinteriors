...
// $access_code='AVRZ05LC61CB88ZRBC';
$working_key='04716BADDDEE5F1738E6476B905EFF9C';//Shared by CCAVENUES
$access_code='AVCY79LD18BG56YCGB';//Shared by CCAVENUES
// $access_code = 'AVXT74LC28BT11TXTB';
// $working_key = '9F23C78885B1A7E9DEAE9E7CE9A4FC6C';

$customer_name='';

if((isset($userData) && !empty($userData)) && (isset($orderData) && !empty($orderData))){
    $customer_id = $userData['id'];
    $customer_code = $userData['phone'];
    $customer_email = $userData['email'];
    $customer_phone = $userData['phone'];
    $amount = $orderData['actualAmountToPay'];  
    $payable_amount = $orderData['actualAmountToPay'];
    if($customer_id==4){
        $amount = 1;
        $payable_amount = 1;
    }
    ...
    $merchant_data.='redirect_url'.'='.base_url().'checkout/mobile_order_pay_status&';
    $merchant_data.='cancel_url'.'='.base_url().'checkout/mobile_order_pay_status&';
    ...
    $merchant_data.='billing_address'.'='.pay_gateway_chars_slug($orderData['deliveryAddress'],"150").'&';
    ...
    $merchant_data.='merchant_param3'.'='.$orderData['id'].'&';
