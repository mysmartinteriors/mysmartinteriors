      	...
      	<div class="row">
			...
			<div class="col-lg-6">
				<div class="form-group">
					  ...
					  <input class="form-control" name="password" value="" type="password" data-edit="" required>
				</div> 
				</div>      
			<div class="col-lg-6">
		        <div class="form-group">
			...
			<div class="col-lg-6">
				<div class="form-group">
					  ...
					  <!-- <input class="form-control" name="availability" value="<?php echo $availability; ?>" type="text" data-edit="<?=$availability; ?>" required> -->
				</div> 
				</div>      
				<div class="col-lg-6">
					<div class="ibox"> 
						...
						<div class="ibox-body">
							<input type="file" id="imageinput" name="profile_picture[]" class="dropify" data-max-file-size="2M" accept="jpg,jpeg,png,PNG" data-height="180" data-url="<?php echo base_url()?>uploads/delivery/" data-logo="<?php echo $profile_picture ?>" required>
				...
				<div class="col-lg-6">
					<div class="ibox"> 
						...
						<div class="ibox-body">
							<input type="file" id="imageinput" name="aadhaar_card[]" class="dropify" data-max-file-size="2M" data-height="180" data-url="<?php echo base_url()?>uploads/delivery/" data-logo="<?php echo $aadhaar_card ?>" title="" accept=".jpg,.png.jpeg"/ required>
				...
				<div class="col-lg-6">
					<div class="ibox"> 
						...
						<div class="ibox-body">
							<input type="file" id="imageinput" name="pan_card[]" class="dropify" data-max-file-size="2M" data-height="180" data-url="<?php echo base_url()?>uploads/delivery/" data-logo="<?php echo $pan_card ?>" title="" accept=".jpg,.png.jpeg"/ required>
				...
				<div class="col-lg-6">
					<div class="ibox"> 
						...
						<div class="ibox-body">
							<input type="file" id="imageinput" name="driving_licence[]" class="dropify" data-max-file-size="2M" data-height="180" data-url="<?php echo base_url()?>uploads/delivery/" data-logo="<?php echo $driving_licence ?>" title="" accept=".jpg,.png.jpeg"/ required>
				...
				<div class="col-lg-6">
					<div class="ibox"> 
						...
						<div class="ibox-body">
							<input type="file" id="imageinput" name="vehicle_rc[]" class="dropify" data-max-file-size="2M" data-height="180" data-url="<?php echo base_url()?>uploads/delivery/" data-logo="<?php echo $vehicle_rc ?>" title="" accept=".jpg,.png.jpeg"/ required>
