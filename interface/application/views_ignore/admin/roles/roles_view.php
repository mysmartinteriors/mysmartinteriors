...
<body class="fixed-navbar fixed-layout">
                    ...
                    <div class="col-12">                       
                        <div class="ibox">                            
                            <div class="ibox-head page-head-btns">
                                <div class="ibox-title">Here you can manage your user roles</div>
                                <div class="btn btn-success btn-labeled btn-labeled-left btn-icon" onclick="window.location.href='<?php echo base_url() ?>admin/roles/add'">
    ...
    <script src="<?php echo base_url() ?>ui/assets/js/my-scripts/roles.js" type="text/javascript"></script>  
</body>
</html>