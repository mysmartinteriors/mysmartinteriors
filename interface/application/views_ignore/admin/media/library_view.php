                    ...
                    <div class="col-12">                       
                        <div class="ibox">                            
                            <div class="ibox-head page-head-btns">
                                <div class="ibox-title">Manage media libraries</div>
                                <div class="btn btn-success btn-labeled btn-labeled-left btn-icon" onclick="uploadMedia(this);">
                                    <span class="btn-label"><i class="la la-upload"></i></span>Upload File
                                </div>
                            </div>
                                <div class="ibox-body adv_filter tblbox">
                                        <div class="row mb-4">
                                            <div class="col-sm-10 col-11">
                                                <div class="input-group  pull-left" id="adv-search">
                                                    <input type="text" class="form-control refine_filter clearAbleFilt" id="product" data-type="search" placeholder="Search by file name..." />
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-6 form-group">
                                                                                ...
                                                                                <select class="form-control refine_filter float-right" data-type="perpage" id="perpage">
                                                                                    <option data-type="perpage" value="30">10</option>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div id="libraryTbl"></div>
                                                <div id="page_result" class="library_pres"></div>
                                            </div>
                                        </div>
                                    </div>                                  
                                </div>
