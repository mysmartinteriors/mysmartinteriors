...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo base_url() ?>uploads/logo/favicon-32x32.png">  
        ...
        <form class="ibox-body" id="login-form" action="javascript:;" method="POST">
            <div class="row">
                ...
                <div class="col-12 form-group mb-4">
                    <input class="form-control form-control-line" type="text" name="uid" placeholder="Username" value="<?php if(isset($_COOKIE['user_remember_me'])) echo $this->input->cookie('user_remember_me',TRUE);  ?>">
                </div>
