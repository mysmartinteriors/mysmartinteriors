...
<body class="fixed-navbar fixed-layout">
    <div class="page-wrapper">
        ...
        <!-- end row -->
                <div class="row">
                    <div class="col-12">                       
                        <div class="ibox"> 
                            <div class="ibox-head featured-prd-head">
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="ibox-title">Manage featured products display</div>
                                    </div>
                                    <div class="col-md-3">
                                        <form id="add_featureprd_form" role="form">
                                            <div class="input-group">
                                              <input class="form-control form-control-air" type="text" name="productCode" placeholder="Enter product code...">
                                                                    ...
                                                                    <form class="form-horizontal" role="form">
                                                                        <!-- <div class="row">
                                                                            <div class="col-6 form-group">
                                                                                <label for="contain">Search by code</label>
                                                                                <input class="form-control refine_filter clearAbleFilt" data-type="products-code" id="products-code" placeholder="Enter product code...">
                                                                            </div>
                                                                            <div class="col-6 form-group">
                                                                                <label for="contain">Search by name</label>
                                                                                <input class="form-control refine_filter clearAbleFilt" data-type="products-name" id="products-name" placeholder="Enter product name...">
                                                                            </div>
                                                                        </div> -->
                                                                        <div class="row">
                                                                            <div class="col-6 form-group">
    ...
    <?php echo $commonJs ?>
    <script src="<?php echo base_url(); ?>ui/assets/js/my-scripts/feature_products.js"></script>
</body>
</html>
