     ...
     <table class="table table-bordered mb-0">
        ...
        <tbody>
            ...
            <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url() ?>admin/customers/referrals/<?php echo $rowData['id']; ?>" class="badge <?php echo $rowData['referrals_count']>0?'badge-success':'badge-danger' ?>">Referrals : <?php echo $rowData['referrals_count']; ?> </a>
                    </td>
                    <td>
                    ...
                    <td>
                        <?php echo !empty($rowData['createdDate'])?$rowData['createdDate']:'N/A' ?>
                    </td>
                    <td>
