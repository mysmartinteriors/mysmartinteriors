                    ...
                    <tr>
                        ...
                        <td>
                            <div class="tbl-action-holder">
                                <button class="tbl-action-btn btn btn-info btn-icon-only btn-circle btn-sm btn-air btn-editData" data-id="<?php echo $rowData['id']; ?>" title="Edit">
                                    <i class="ti-pencil"></i>
                                </button>
                            </div>
                        </td>
...
<script>
    $(".btn-editData").on('click', function(e){
        ...
        title: 'Edit Repurchase Percentage',
