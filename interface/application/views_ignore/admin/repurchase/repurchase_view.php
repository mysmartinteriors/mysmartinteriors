...
<body class="fixed-navbar fixed-layout">
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            <div class="page-heading">
                <h1 class="page-title">Re-Purchase Comissions</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="<?php echo base_url() ?>admin/dashboard"><i class="la la-home font-20"></i></a>
                    </li>
                    <li class="breadcrumb-item">Re-Purchase Comissions</li>
                    ...
                    <div class="col-12">                       
                        <div class="ibox">                            
                            <div class="ibox-head page-head-btns">
                                <div class="ibox-title">Here are the list of re-purchase comissions percentage for customers</div>
    ...
    <script src="<?php echo base_url(); ?>ui/assets/js/my-scripts/repurchase.js"></script>
</body>
</html>
