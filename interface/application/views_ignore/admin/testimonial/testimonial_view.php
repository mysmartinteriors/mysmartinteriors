...
<body class="fixed-navbar fixed-layout">
                    ...
                    <div class="col-12">                       
                        <div class="ibox">                            
                            <div class="ibox-head page-head-btns">
                                <div class="ibox-title">Manage homepage testimonial settings</div>
                                                                    ...
                                                                    <form class="form-horizontal" role="form">
                                                                        <div class="row">
                                                                            <div class="col-6 form-group">
                                                                                <label for="contain">Search by slider</label>
                                                                                <input class="form-control refine_filter clearAbleFilt" data-type="slideName" id="slideName" placeholder="Enter slider name...">
                                                                            </div>
                                                                            <div class="col-6 form-group">
                                                                                <label for="filter">Filter by status</label>
                                                                                <select class="form-control refine_filter clearAbleFilt" data-type="status" id="status">
                                                                                    <option data-type="status" value="">--All sliders--</option>
    ...
    <?php echo $commonJs ?>
    <script src="<?php echo base_url(); ?>ui/assets/js/my-scripts/testimonial.js"></script>
</body>
</html>
