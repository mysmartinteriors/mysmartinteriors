...
<body class="fixed-navbar fixed-layout">
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            <div class="page-heading">
                <h1 class="page-title">Challan History</h1>
                <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                        <div class="ibox">
                            <div class="ibox-head page-head-btns">
                                <div class="ibox-title">Manage your DC Challan Histories</div>
                                <!-- <div class="btn btn-success btn-labeled btn-labeled-left btn-icon"
                                    onclick="window.location.href='<?php //echo base_url() ?>vendors/dashboard/add'">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-6 form-group">
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            <option data-type="status" value="">--All
                                                                                customers--</option>
                                                                            <option data-type="status" value="1">Active
                                                                            </option>
                                                                            <option data-type="status" value="0">
                                                                                Inactive</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-6 form-group">
                                                                        ...
                                                                        <select class="form-control refine_filter"
                                                                            ...
                                                                            <option data-type="sortBy" value="">Newest
                                                                                First</option>
                                                                            <option data-type="sortBy"
                                                                                value="createdAsc">Oldest First</option>
                                                                            <option data-type="sortBy"
                                                                                value="updatedDesc">Last Updated
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-6 form-group">
    ...
    <?php echo $commonJs ?>
    <script src="<?php echo base_url(); ?>ui/assets/js/my-scripts/vendor_panel_challan_history.js"></script>
