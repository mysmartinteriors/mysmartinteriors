...
<table>
	...
	<tr style="text-align: center;font-family: 'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif !important;">
		<td style="font-size: 9px;line-height: 7px;color:#212529">
			...
			<p>Ph: +91-87624 63738 | Email: nalaaorganic@gmail.com </p>
...
<table>
	<tr style="font-family: calibri !important;">
		<td style="color:#212529;width: 50%;text-align: left;font-size: 9px;line-height: 5px;">
			...
			<!-- firstname
lastname -->
			<p style="line-height: 9px;"><strong style="font-size: 10px;"><?php echo $order_data['deliveryAddress'];?></strong><br><?php //if($caddress!=''){echo ucwords($caddress);}if($pincode!=''){echo '-'.$pincode;}?><br>Ph: <?php echo $phone;?></p>
			...
			<table style="line-height: 16px;">
				<tr>				
					...
					<td style="width:50%;text-align: right;">
						<p><?php echo "Rs. ". $order_data['totalAmount'] - ($order_data['taxAmount']>0?$order_data['taxAmount']:0) - ($order_data['deliveryCharge']>0?$order_data['deliveryCharge']:0) ?></p>
					</td>
				</tr>
				<tr>				
					<td style="width:50%;text-align: left;">
