                          ...
                          <div class="row">
                            <div class="col-md-10">
                              ...
                              <div class="row form-footer">
                                <div class="d-flex justify-content-around w-100 account_btns">
                                  <button type="submit" class="btn btn-primary login_btn" data-loading-text="<span class='btn-label'><i class='fa fa-spinner fa-spin '></i></span> Logging in..."><i class='fa fa-sign-in'></i> Login</button>
