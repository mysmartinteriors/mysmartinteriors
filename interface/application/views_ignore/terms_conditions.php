    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="about-section">
                <div class="container">
                    <h2 class="subtitle">Welcome to Nalaa Organic</h2>
                    <p>These terms of service outline the rules and regulations for the use of Nalaa Organic’s Website.
                    </p>
                    <p>Nalaa Organic is located at:<br><span>Bangalore Bangalore`, BANGALORE
                            <br>
                            562123-Karnataka , India</span></p>
                    <p>By accessing this website we assume you accept these terms of service in full. Do not continue to
                        use Nalaa Organic’s website if you do not accept all of the terms of service stated on this
                        page.</p>
                    <p>The following terminology applies to these Terms of Service, Privacy Statement and Disclaimer
                        ...
                        stated services/products, in accordance with and subject to, prevailing law of India. Any use of
                ...
                <div class="container">
                    ...
                    <p>We employ the use of cookies. By using Nalaa Organic’s website you consent to the use of cookies
                        in accordance with Nalaa Organic’s privacy policy.</p>
                ...
                <div class="container">
                    ...
                    <p>Unless otherwise stated, Nalaa Organic and/or it’s licensors own the intellectual property rights
                        for all material on Nalaa Organic. All intellectual property rights are reserved. You may view
                        and/or print pages from nalaaorganic.com for your own personal use subject to restrictions set
                        in these terms of service.</p>
                    <p>You must not:</p>
                    <ol>
                        <li>Republish material from nalaaorganic.com</li>
                        <li>Sell, rent or sub-license material from nalaaorganic.com</li>
                        <li>Reproduce, duplicate or copy material from nalaaorganic.com</li>
                    </ol>
                    <p>Redistribute content from Nalaa Organic (unless content is specifically made for redistribution).
                    </p>
                </div><!-- End .container -->
                <div class="container">
                    <h2 class="subtitle">Shipping & Delivery</h2>
                    <p>The order will be delivered within your selected timeframe while ordering with maximum Turn
                        around time of 0-4 days</p>
                </div><!-- End .container -->
                <div class="container">
                    <h2 class="subtitle">User Comments</h2>
                    <ol>
                        <li>This Agreement shall begin on the date hereof.</li>
                        <li>Certain parts of this website offer the opportunity for users to post and exchange opinions,
                            information, material and data (‘Comments’) in areas of the website. Nalaa Organic does not
                            screen, edit, publish or review Comments prior to their appearance on the website and
                            Comments do not reflect the views or opinions of Nalaa Organic, its agents or affiliates.
                            Comments reflect the view and opinion of the person who posts such view or opinion. To the
                            extent permitted by applicable laws Nalaa Organic shall not be responsible or liable for the
                            Comments or for any loss cost, liability, damages or expenses caused and or suffered as a
                            result of any use of and/or posting of and/or appearance of the Comments on this website.
                        </li>
                        <li>Nalaa Organic reserves the right to monitor all Comments and to remove any Comments which it
                        ...
                        <li>You warrant and represent that
                            <ul>
                                ...
                                <li>The Comments do not contain any defamatory, libelous, offensive, indecent or
                                    otherwise unlawful material or material which is an invasion of privacy</li>
                        ...
                        <li>You hereby grant to Nalaa Organic a non-exclusive royalty-free license to use, reproduce,
                            edit and authorize others to use, reproduce and edit any of your Comments in any and all
                            forms, formats or media.</li>
                    </ol>
                </div><!-- End .container -->
                <div class="container">
                    ...
                    <ol>
                        ...
                        <li>These organizations may link to our home page, to publications or to other Web site
                            ...
                            services; and (c) fits within the context of the linking party’s site.</li>
                        <li>We may consider and approve in our sole discretion other link requests from the following
                            ...
                            <ul>
                                <li>commonly-known consumer and/or business information sources such as Chambers of
                                    Commerce, American Automobile Association, AARP and Consumers Union;</li>
                    ...
                    <p>We will approve link requests from these organizations if we determine that: (a) the link would
                        ...
                        opportunities, shall not be allowed to link); (b)the organization does not have an
                        unsatisfactory record with us; (c) the benefit to us from the visibility associated with the
                        hyperlink outweighs the absence of Nalaa Organic; and (d) where the link is in the context of
                        general resource information or is otherwise consistent with editorial content in a newsletter
                    ...
                    <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to
                        our website, you must notify us by sending an e-mail to <a
                            href="mailto:">nalaaorganic@gmail.com</a>. Please include your name, your organization name,
                        contact information (such as a phone number and/or e-mail address) as well as the URL of your
                        site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s)
                    ...
                    No use of Nalaa Organic’s logo or other artwork will be allowed for linking absent a trademark
                    license agreement.
                    </p>
                </div><!-- End .container -->
                <div class="container">
                ...
                <div class="container">
                    ...
                    <p>We reserve the right at any time and in its sole discretion to request that you remove all links
                        ...
                        site upon such request. We also reserve the right to amend these terms of service and its
                        linking policy at any time. By continuing to link to our Web site, you agree to be bound to and
                        abide by these linking terms of service.</p>
                </div><!-- End .container -->
                <div class="container">
                ...
                <div class="container">
                    <h2 class="subtitle">Credit & Contact Information</h2>
                    <p>This Terms of service page was created at privacyterms.io terms & conditions generator. If you
                        have any queries regarding any of our terms, please contact us.</p>
                </div><!-- End .container -->
                        ...
                        <div class="col-lg-4">
                            <div class="feature-box">
                                ...
                                <div class="feature-box-content">
                                    ...
                                    <p>Enjoy complimentary shipping on orders totaling above &#8377; 375. Shop now and
                                        indulge in hassle-free delivery!</p>
                        ...
                        <div class="col-lg-4">
                            <div class="feature-box">
                                ...
                                <div class="feature-box-content">
                                    ...
                                    <p>Conveniently choose between secure online payment or opt for cash on delivery to
                                        suit your preference when placing your order.</p>
                                </div><!-- End .feature-box-content -->
                            </div><!-- End .feature-box -->
                        </div><!-- End .col-lg-4 -->
                        ...
                        <div class="col-lg-4">
                            <div class="feature-box">
                                ...
                                <div class="feature-box-content">
                                    ...
                                    <p>Access round-the-clock online support to address any queries or concerns whenever
