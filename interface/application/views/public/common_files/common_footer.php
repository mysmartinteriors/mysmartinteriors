                    ...
                    <form method="POST">
                        <div class="form-row">
                            <div class="col-12 d-sm-block d-none">
                                <input type="email" name="email" id="emailadd" class="form-control upper_layer"
                                    placeholder="Your Email Address">
                                <div class="input-group-append form-button">
                                    <button class="btn subscribe_now" name="btnsubmit" id="submitbtn"
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="links mb-0 list-unstyled">
                        ...
                        <li class="d-sm-inline-block d-none"><a href="<?php echo base_url() ?>services">Services</a>
                        </li>
                        <li class="d-sm-inline-block d-none"><a href="<?php echo base_url() ?>projects">Projects</a>
                        </li>
                        <!-- <li class="d-sm-inline-block d-none"><a href="blog.html">Blogs</a></li> -->
