function MenuEditor(l, t) {
    var i = $("#" + l),
        r = {
			labelMega: '<i class="fas fa-cog clickable"></i>',
    ...
    function p(e) {
        return $("<a>").addClass(e.classCss).addClass("clickable").attr("href", "javascript:void(0)").html(e.text)
    }
    ...
    function f() {
        var e = $("<div>").addClass("btn-group float-right"),
			...
			m = p({
                classCss: "btn btn-warning btn-sm btnMega",
                text: r.labelMega
            }),
            t = p({
        ...
        return e.append(l).append(n).append(i).append(o).append(m).append(s).append(t), e
    }
