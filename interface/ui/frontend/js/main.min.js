	...
	var o = {
		...
		stickyHeader: function () {
			if (e(".sticky-header").length) {
				...
				if (!e(".header-bottom").find(".logo, .cart-holder").length) {
					var o = e(".header-bottom").find(".container");
					e(".header").find(".logo, .cart-holder").clone(!0).prependTo(o)
				}
			}
		...
		// productQuantityInputs: function () {
		// 	e.fn.TouchSpin && (e(".product-vertical-quantity").TouchSpin({
		// 		verticalbuttons: !0,
		// 		verticalup: "",
		// 		verticaldown: "",
		// 		verticalupclass: "icon-up-dir",
		...
		// 		min: 1,
		// 		max:10
		// 	}), e(".product-horizontal-quantity").TouchSpin({
		// 		verticalbuttons: !1,
		// 		buttonup_txt: "",
		// 		buttondown_txt: "",
		// 		buttondown_class: "btn btn-outline btn-down-icon",
