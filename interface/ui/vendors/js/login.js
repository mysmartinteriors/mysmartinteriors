...
function login() {
    $('#login-form').validate({
        ...
        messages:{
            uid :{required :"Please enter your registered mobile number"},
        ...
        submitHandler: function(){
          ...
          form_btn.html(form_btn.prop('disabled', true).data("loading-text"));
            ...
            $.post(urljs+"vendors/login/authentication",admin,function(data){
    ...
    $('#aforgot-form').validate({
        ...
        submitHandler: function(){
          ...
          form_btn.html(form_btn.prop('disabled', true).data("loading-text"));
            ...
            $.post(urljs+"vendors/login/forgot_pass",admin,function(data){
                if(data.result>0){
                   form_btn.prop('disabled', false).html(form_btn_old_msg);
